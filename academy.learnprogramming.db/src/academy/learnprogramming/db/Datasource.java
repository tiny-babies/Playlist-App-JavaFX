...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:D:\\Downloads\\music\\" + DB_NAME;
    ...
    public static Datasource getInstance(){
        return instance;
        //Datasource.getInstance().methodName() to access everything in the class
    }
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            conn.setAutoCommit(false); //start transaction (everything must work or else commit nothing, so there is no incomplete commit).
            ...
            if (affectedRows == 1) { //how many rows affected? (should be 1 because only 1 row is added)
                conn.commit();
            } else {
